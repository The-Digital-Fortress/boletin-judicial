...
const matchedFilesTable = (matchedFiles: any[], fileName: string) => {
    ...
    <div>
      {
        matchedFiles.length > 0 && (
          <div className='mt-16 mx-auto max-w-7xl lg:px-8'>
            <p className='text-center font-semibold text-xl text-black py-4 bg-green-500 rounded-md border-2 border-green-500'>Expedientes encontrados!</p>
...
const unmatchedFilesTable = (unmatchedFiles: any[], fileName: string) => {
    ...
    <div>
      {
        unmatchedFiles.length > 0 && (
          ...
          <div className='mt-16 mx-auto max-w-7xl lg:px-8'>
            <p className='text-center font-semibold text-xl text-black py-4 bg-rose-500 rounded-md border-2 border-rose-500'>Expedientes no encontrados</p>
            <div className='flex items-center border-b-2 justify-between border-gray-300 '>
              <p className='text-center font-semibold text-lg flex-1 '>
                Numero de archivo
              </p>
...
const Boletin = () => {
  ...
  return (
    <div>
      ...
      {matchedFilesTable(matchedFiles, fileName)}
      {unmatchedFilesTable(unmatchedFiles, fileName)}
